...
exports.MCPAutoAgentTool = exports.MCPChatTool = exports.MCPQueryTool = exports.MCPLanguageModelTool = void 0;
exports.registerLanguageModelTools = registerLanguageModelTools;
exports.getToolsInfo = getToolsInfo;
...
class MCPLanguageModelTool {
    ...
    mcpClient;
    description;
    constructor(toolName, mcpClient, description) {
 ...
 */
class MCPQueryTool extends MCPLanguageModelTool {
...
class MCPChatTool extends MCPLanguageModelTool {
    ...
    async fallbackSendToChat(message) {
        try {
...
class MCPAutoAgentTool extends MCPLanguageModelTool {
    ...
    async fallbackTriggerAgent(prompt) {
        try {
...
exports.MCPAutoAgentTool = MCPAutoAgentTool;
/**
